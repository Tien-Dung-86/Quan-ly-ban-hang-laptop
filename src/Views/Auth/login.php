...
<head>
    ...
    <style>
        body{
            background-image: url("Images/Gaming/msi-RGB-1.jpg") ;
        }
        .header {
            color: darkslateblue;
            text-align: center;
...
<form id="login" method="post">
    ...
    <table>
        ...
        <tr>
            ...
            <td style="text-align: right"><a href="#" id="forgot">Quên mật khẩu</a></td>
        </tr>
        <tr>
            <td colspan="2">
                <button type="submit" id="submitLogin">Đăng nhập
            </td>
        </tr>
    </table>
</form>
